...
SRC = src/main.c src/app.c src/ui/ui.c src/ui/dpi.c src/locale.c src/theme_meta.c src/theme.c src/data.c src/miniz.c src/file_dialog.c src/android/android_share.c src/tabs/history_tab.c src/tabs/language_tab.c src/tabs/manual_tab.c src/tabs/settings_tab.c
INBE_DIR = libinbe
