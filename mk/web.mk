...
WEB_ASSET_FILES = $(CONFIG_FILES) $(IMAGE_FILES) $(LOCALE_FILES) $(ICON_FILES) $(THEME_FILES) $(WEB_SOUND_FILES)
...
$(WEB_TARGET): $(BUILD_MAKEFILES) $(SRC) $(INBE_DIR)/inbe.c $(WEB_SHELL) $(WEB_RAYLIB_A) $(WEB_ASSET_FILES) | $(WEB_BUILD_DIR)
	$(WEB_CC) $(WEB_CFLAGS) \
		-I$(RAYLIB_DIR) \
		-I$(INBE_DIR) \
		-Isrc -Isrc/android \
