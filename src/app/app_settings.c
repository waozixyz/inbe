...
save_settings(InbeApp *app)
{
    ...
    const IntSetting int_settings[] = {
        ...
        {"bottom_nav_count", app->bottom_nav_count},
        {"bottom_nav_slot_0", app->bottom_nav_routes[0]},
        {"bottom_nav_slot_1", app->bottom_nav_routes[1]},
        {"bottom_nav_slot_2", app->bottom_nav_routes[2]},
        {"bottom_nav_slot_3", app->bottom_nav_routes[3]},
        {"bottom_nav_slot_4", app->bottom_nav_routes[4]},
        {"bottom_nav_slot_5", app->bottom_nav_routes[5]},
        {"bottom_nav_slot_6", app->bottom_nav_routes[6]},
        {"bottom_nav_slot_7", app->bottom_nav_routes[7]},
...
app_load_settings(InbeApp *app)
{
...

    {
        LoadedClampedSetting settings[] = {
            ...
            {&app->bottom_nav_count, "bottom_nav_count", 3,
             0, APP_BOTTOM_NAV_MAX_ITEMS},
            {&app->bottom_nav_routes[0], "bottom_nav_slot_0", APP_NAV_ROUTE_HABITS,
             APP_NAV_ROUTE_PRACTICE, APP_NAV_ROUTE_SETTINGS},
            {&app->bottom_nav_routes[1], "bottom_nav_slot_1", APP_NAV_ROUTE_PRACTICE,
             APP_NAV_ROUTE_PRACTICE, APP_NAV_ROUTE_SETTINGS},
            {&app->bottom_nav_routes[2], "bottom_nav_slot_2", APP_NAV_ROUTE_STATISTICS,
             APP_NAV_ROUTE_PRACTICE, APP_NAV_ROUTE_SETTINGS},
            {&app->bottom_nav_routes[3], "bottom_nav_slot_3", APP_NAV_ROUTE_SETTINGS,
             APP_NAV_ROUTE_PRACTICE, APP_NAV_ROUTE_SETTINGS},
            {&app->bottom_nav_routes[4], "bottom_nav_slot_4", APP_NAV_ROUTE_HABITS,
             APP_NAV_ROUTE_PRACTICE, APP_NAV_ROUTE_SETTINGS},
            {&app->bottom_nav_routes[5], "bottom_nav_slot_5", APP_NAV_ROUTE_PRACTICE,
             APP_NAV_ROUTE_PRACTICE, APP_NAV_ROUTE_SETTINGS},
            {&app->bottom_nav_routes[6], "bottom_nav_slot_6", APP_NAV_ROUTE_STATISTICS,
             APP_NAV_ROUTE_PRACTICE, APP_NAV_ROUTE_SETTINGS},
            {&app->bottom_nav_routes[7], "bottom_nav_slot_7", APP_NAV_ROUTE_SETTINGS,
             APP_NAV_ROUTE_PRACTICE, APP_NAV_ROUTE_SETTINGS},
