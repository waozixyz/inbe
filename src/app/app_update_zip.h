#ifndef APP_APP_UPDATE_ZIP_H
#define APP_APP_UPDATE_ZIP_H

/*
 * Extract a release zip into a directory, rejecting path-traversal
...
int update_zip_mkdir_p(const char *path);
...
int update_zip_extract(const char *zip_path, const char *dest_dir);
