...
static int
android_runtime_asset_download(RuntimeAssetDownload *download,
                               const char *url,
                               const char *path)
{
...
android_runtime_asset_native_succeeded(JNIEnv *env, jobject thiz,
                                       ...
                                       jint http_status)
{
    RuntimeAssetDownload *download = (RuntimeAssetDownload *)(intptr_t)handle;
    (void)env;
    (void)thiz;
